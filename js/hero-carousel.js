// GSS — homepage hero carousel: autoplay with arrow controls, looping
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Only the arrows themselves pause on hover/focus — the hero spans
    ...
    var controls = carousel.querySelectorAll('.hero-carousel__arrow');
